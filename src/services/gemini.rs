...
pub async fn send_image_to_gemini_api(
    ...
    let prompt_text = "I am giving you a image give me only a json and nothing more with concise summary of this image starting with CONCISESUMMARY: and then give me 200 keywords to search for this image starting with KEYWORDS:";
